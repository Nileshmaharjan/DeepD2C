...
images_to_be_aligned_path = 'C:/DL lecture slides/DeepD2C/ber_test_directory/90_degree/10cm'
referenced_images_path = 'C:/DL lecture slides/DeepD2C/ber_test_directory/reference_images'
aligned_images_path = 'C:/DL lecture slides/DeepD2C/ber_test_directory/90_degree/10cm_modified'

import os
from pathlib import Path


images_to_be_aligned_path_modified = sorted(Path(images_to_be_aligned_path).iterdir(), key=os.path.getmtime)
...
for index, file in enumerate(images_to_be_aligned_path_modified):
    ...
    # Save the output.
    filename = "modified-" + str(index + 1) + '.jpg'
